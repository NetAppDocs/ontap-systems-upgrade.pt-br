...
summary: 'Mova agregados não-raiz e LIFs de dados nas de node1 para node2 e mova os recursos do node1 para node3 ao atualizar controladores executando ONTAP 9.15,1 ou posterior usando `system controller replace` comandos.' 
---
