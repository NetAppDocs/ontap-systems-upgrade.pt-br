...
summary: 'Mova os agregados não raiz e as LIFs de dados NAS do nó 1 para o nó 2 e mova os recursos do nó 1 para o nó 3 ao atualizar para controladores introduzidos no ONTAP 9.15.1 ou posterior usando os comandos  `system controller replace`.' 
---
...
.O que se segue?
Após realocar agregados não raiz e LIFs de dados NAS pertencentes ao node1 para o node2, link:relocate-failed-or-vetoed-aggr-node2.html["realocar agregados com falha ou vetados para o node2"].
