...
summary: 'O sistema pode apresentar falhas – reinicializar, entrar em pânico ou passar por um ciclo de energia – durante diferentes estágios ao atualizar para controladores introduzidos no ONTAP 9.15.1 ou posterior usando  `system controller replace` comandos.' 
---
