...
summary: 'LIFs não estão online após a migração no Estágio 2, Estágio 3 ou Estágio 5 ao atualizar para controladores introduzidos no ONTAP 9.15.1 ou posterior usando  `system controller replace` comandos.' 
---
