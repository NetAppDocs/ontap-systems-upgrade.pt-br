...
summary: 'Caso necessário, restaure a configuração do gerenciador de chaves no nó 3 ao atualizar para controladores introduzidos no ONTAP 9.15.1 ou posterior usando  `system controller replace` comandos.' 
---
...
.O que se segue?
Após restaurar a configuração do gerenciador de chaves no node3, link:move_non-root_aggr_and_nas_data_lifs_node1_from_node2_to_node3.html["mova agregados não raiz e LIFs de dados NAS pertencentes ao nome do nó1 do nó2 para o nó3"].
