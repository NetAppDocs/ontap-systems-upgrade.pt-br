...
summary: 'Habilite o par de HA, verifique o acesso ao storage dos nodes 3 e 4 e confirme a propriedade do agregado após a atualização para controladores introduzidos no ONTAP 9.15.1 ou posterior, utilizando os comandos  `system controller replace`.' 
---
...
.O que se segue?
Após confirmar que os novos controladores estão configurados corretamente, link:set_up_storage_encryption_new_module.html["Configurar a criptografia de armazenamento no novo módulo controlador"].
