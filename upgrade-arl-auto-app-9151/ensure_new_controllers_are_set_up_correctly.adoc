...
+
Consulte link:other_references.html["Referências"]o _System Administration Reference_ para obter informações sobre os SPs e o _ONTAP 9 Command reference_ para obter informações detalhadas sobre o comando do sistema `service-processor network modify`.
