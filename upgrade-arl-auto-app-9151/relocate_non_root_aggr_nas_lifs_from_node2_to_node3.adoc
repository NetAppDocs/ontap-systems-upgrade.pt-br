...
summary: 'Realoque os agregados não raiz do node2 para o node3 ao atualizar para controladores introduzidos no ONTAP 9.15.1 ou posterior usando  `system controller replace` comandos.' 
---
...
.O que se segue?
Após realocar agregados não raiz e LIFs de dados NAS do nó2 para o nó3, link:relocate-failed-or-vetoed-aggr-node3.html["realocar agregados com falha ou vetados para node3"].
