...
summary: 'Desative o par de HA com o node2 e desligue o node1 ao atualizar para controladores introduzidos no ONTAP 9.15.1 ou posterior usando  `system controller replace` comandos.' 
---
= Aposentar-se node1
:hardbreaks:
:allow-uri-read: 
...
.O que se segue?
Após a desativação do node1, link:prepare_for_netboot.html["Preparar para inicialização de rede"].
