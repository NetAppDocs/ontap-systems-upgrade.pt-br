...
** Para um sistema FAS70 e FAS90, o ONTAP converte apenas a eficiência de storage de volumes thin Provisioning existentes que já tinham a eficiência de storage habilitada antes da atualização.
