...
summary: 'Informações sobre problemas que podem ocorrer ao atualizar para controladores introduzidos no ONTAP 9.15.1 ou posterior usando  `system controller replace` comandos.' 
---
