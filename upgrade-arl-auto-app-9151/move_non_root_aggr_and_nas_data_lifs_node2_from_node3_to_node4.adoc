...
summary: 'Verifique se as LIFs de dados NAS do nó 2 que estão no nó 3 foram realocadas do nó 3 para o nó 4 ao atualizar para controladores introduzidos no ONTAP 9.15.1 ou posterior usando  `system controller replace` comandos.' 
---
