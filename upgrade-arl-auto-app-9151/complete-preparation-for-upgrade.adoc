...
summary: 'Configure e gerencie a criptografia de armazenamento, gerencie as chaves de autenticação e suspenda os relacionamentos SnapMirror ao atualizar para controladores introduzidos no ONTAP 9.15.1 ou posterior usando o comando  `system controller replace`.' 
---
