...
summary: 'Solucione problemas de falhas que podem ocorrer ao atualizar controladores executando o ONTAP 9.15,1 ou posterior usando `system controller replace` comandos.' 
---
