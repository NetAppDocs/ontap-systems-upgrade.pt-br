...
summary: 'Realoque manualmente agregados com falha ou vetados para o node2 ao atualizar controladores executando ONTAP 9.15.1 ou posterior usando `system controller replace` comandos.' 
---
