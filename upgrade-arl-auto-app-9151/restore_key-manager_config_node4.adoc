...
summary: 'Caso necessário, restaure a configuração do gerenciador de chaves no nó 4 ao atualizar para controladores introduzidos no ONTAP 9.15.1 ou posterior usando  `system controller replace` comandos.' 
---
...
.O que se segue?
Após restaurar a configuração do gerenciador de chaves no nó4, link:move_non_root_aggr_and_nas_data_lifs_node2_from_node3_to_node4.html["mova agregados não raiz e LIFs de dados NAS pertencentes ao nó2 do nó3 para o nó4"].
