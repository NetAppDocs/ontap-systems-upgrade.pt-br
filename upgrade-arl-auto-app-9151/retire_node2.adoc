...
summary: 'Desligue o nó 2 e remova-o do rack ou chassi ao atualizar para controladores introduzidos no ONTAP 9.15.1 ou posterior usando os comandos  `system controller replace`.' 
---
= Aposentar-se node2
:hardbreaks:
:allow-uri-read: 
