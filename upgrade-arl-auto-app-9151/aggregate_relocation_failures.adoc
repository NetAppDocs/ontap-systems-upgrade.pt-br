...
summary: 'Solucione problemas de falhas de realocação de agregados que podem ocorrer ao usar  `system controller replace` comandos para atualizar para controladores introduzidos no ONTAP 9.15.1 ou posterior.' 
---
