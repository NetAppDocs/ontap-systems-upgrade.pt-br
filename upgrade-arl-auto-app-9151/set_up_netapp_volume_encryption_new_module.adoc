...
summary: 'Caso necessário, configure o novo módulo de controlador para NVE ou NAE ao atualizar para controladores introduzidos no ONTAP 9.15.1 ou posterior usando  `system controller replace` comandos.' 
---
...
.O que se segue?
Após configurar a NetApp Volume ou Aggregate Encryption no novo módulo controlador, link:decommission_old_system.html["desativar o sistema antigo"].
