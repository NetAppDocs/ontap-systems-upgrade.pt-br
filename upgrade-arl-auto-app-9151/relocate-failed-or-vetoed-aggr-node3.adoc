...
summary: 'Realoque manualmente os agregados com falha ou vetados para o nó 3 ao atualizar para controladores introduzidos no ONTAP 9.15.1 ou posterior usando os comandos  `system controller replace`.' 
---
= Realocar agregados com falha ou vetados para o node3
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.O que se segue?
Após realocar agregados com falha ou vetados para o nó 3, link:retire_node2.html["desativar node2"].
