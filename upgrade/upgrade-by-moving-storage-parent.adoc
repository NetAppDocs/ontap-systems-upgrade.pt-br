...
---
= Saiba mais sobre a atualização movendo o armazenamento
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.O que se segue?
Após aprender sobre a atualização movendo o armazenamento, link:upgrade-prepare-when-moving-storage.html["prepare-se para a atualização"].
