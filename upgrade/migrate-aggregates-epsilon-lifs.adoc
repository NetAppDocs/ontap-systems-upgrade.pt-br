...
[role="lead"]
Migre os agregados de dados, epsilon e interfaces lógicas (LIFs) no AFF A150, AFF A220 ou FAS2820 nó1 para o nó4.
...
.O que se segue?
link:convert-node1-to-drive-shelf.html["Converter node1 em um compartimento de unidades e conectá-lo ao node3"]
