...
.O que se segue?
Após converter um nó original em uma gaveta de unidades, link:upgrade-attach-shelves-reassign-disks.html["Conecte as prateleiras de armazenamento e reatribua a propriedade dos discos"].
