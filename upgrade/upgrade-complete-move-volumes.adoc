...
summary: 'Para concluir o procedimento de atualização por meio da movimentação de volumes, você precisa configurar o Processador de Serviço (SP), instalar novas licenças e configurar o AutoSupport. Você também pode precisar configurar a criptografia de armazenamento ou de volume e configurar as portas FC ou NCA.' 
---
