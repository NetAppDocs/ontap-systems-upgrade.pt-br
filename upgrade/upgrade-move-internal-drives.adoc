...
.O que se segue?
Após mover as unidades internas do nó original, link:upgrade-attach-shelves-reassign-disks.html["Conecte as prateleiras de armazenamento e reatribua a propriedade dos discos"].
