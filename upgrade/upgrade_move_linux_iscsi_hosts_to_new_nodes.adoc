...
summary: Mova seus volumes SAN para os novos nós criando novas conexões iSCSI e escaneando novamente os caminhos iSCSI para os novos nós. 
---
...
Se você não precisar mover volumes SAN iSCSI ao atualizar movendo volumes, ignore este procedimento e vá para link:upgrade-create-aggregate-move-volumes.html["Crie um agregado e mova volumes para os novos nós"].
...
.O que se segue?
Após migrar os hosts Linux iSCSI para os novos nós, link:upgrade-create-aggregate-move-volumes.html["Crie um agregado e mova os volumes para os novos nós"].
