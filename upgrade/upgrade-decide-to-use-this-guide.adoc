...
* link:upgrade_aff_a250_to_aff_a400_ndu_upgrade_workflow.html["Saiba mais sobre como converter AFF A250 em uma gaveta de unidades e transferir o armazenamento para AFF A400"] (procedimento não disruptivo)
* link:convert-to-drive-shelf.html["Atualize de AFF A150, AFF A220 ou FAS2820 convertendo para um shelf de discos"] (procedimento não disruptivo)
