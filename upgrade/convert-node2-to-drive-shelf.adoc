...
[role="lead"]
Converta o node2 em um shelf de discos e conecte-o ao node4 antes de reatribuir os discos do node2 para o node4. Node1 e node2 são os controladores dentro do shelf de discos.
