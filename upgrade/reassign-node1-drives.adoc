...
summary: Após converter o node1 em um shelf de discos e conectá-lo ao node3, você reatribui os discos que pertenciam anteriormente ao node1 para o node3. 
---
...
[role="lead"]
Reatribua as unidades que estavam anteriormente atribuídas ao node1 ao node3.
