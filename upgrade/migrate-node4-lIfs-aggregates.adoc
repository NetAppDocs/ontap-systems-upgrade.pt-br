...
summary: 'Para concluir a atualização, conecte o node3 ao node4 e, em seguida, migre as interfaces lógicas de dados (LIFs) e os agregados de dados do node4 para o node3.' 
---
...
[role="lead"]
Para concluir a atualização, conecte o node3 ao node4 e, em seguida, migre as interfaces lógicas de dados (LIFs) e os agregados de dados do node4 para o node3.
