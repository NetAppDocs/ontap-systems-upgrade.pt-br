...
+
Tanto o novo agregado quanto o agregado antigo do qual o volume está sendo transferido devem estar no mesmo SVM.
...
.O que se segue?
Após criar um agregado e mover os volumes para os novos nós, link:upgrade-move-lifs-to-new-nodes.html["Mova as LIFs de dados não-SAN e as LIFs de gerenciamento de cluster para os novos nós"].
