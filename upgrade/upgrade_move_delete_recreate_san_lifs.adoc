...
Se o cluster estiver em um ambiente SAN, você deve excluir quaisquer LIFs SAN que não sejam mais necessárias dos nós originais antes de poder remover os nós originais do cluster.
...
.O que se segue?
Após mover, excluir ou criar LIFs SAN, link:upgrade-remove-original-nodes.html["remova os nós originais do cluster"].
