...
summary: 'Migre as interfaces lógicas (LIFs) e os agregados de dados do node2 para o node1 antes de converter o node2 em um drive shelf.' 
---
...
[role="lead"]
Migre as interfaces lógicas (LIFs) e os agregados de dados no AFF A150, AFF A220 ou FAS2820 nó 2 para o nó 1 antes de converter o nó 2 em um gabinete de unidades.

.Antes de começar
Verifique se você atende aos seguintes requisitos:

* Os controladores originais e de substituição têm a mesma versão do ONTAP e patch, quando possível. Consulte a  https://hwu.netapp.com["NetApp Hardware Universe"^] para versões do ONTAP compatíveis.
...
.O que se segue?
link:convert-node2-to-drive-shelf.html["Converter node2 em um compartimento de unidades e conectá-lo ao node4"]
