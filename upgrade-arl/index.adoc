...
summary: Saiba como usar a realocação de agregados para atualizar o hardware do controlador AFF, ASA ou FAS. 
---
= Comece aqui: escolha um procedimento de atualização ARL para hardware de controlador AFF, ASA ou FAS
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Você pode atualizar o hardware do controlador AFF, ASA ou FAS sem interrupção usando a realocação de agregados (ARL). Para outros métodos de atualização do hardware do controlador, consulte link:../upgrade/upgrade-decide-to-use-this-guide.html["Atualize movendo volumes ou armazenamento"].
...
== Atualize para sistemas introduzidos no ONTAP 9.15.1 ou posterior

Se o seu cenário de atualização estiver listado na matriz de sistemas suportados a seguir, vá para link:../upgrade-arl-auto-app-9151/index.html["Use os comandos "system controller replace" para atualizar para o hardware do controlador introduzido no ONTAP 9.15.1 ou posterior"] para iniciar o procedimento de atualização.
...
| AFF A70 | AFF A90 | 9.18.1 e versões posteriores 


| AFF A30 | AFF A50 | 9.18.1 e versões posteriores 


| AFF A20 | AFF A30, AFF A50 | 9.18.1 e versões posteriores 


| AFF C30 | AFF C60 | 9.18.1 e versões posteriores 


| FAS70 | FAS90 | 9.18.1 e versões posteriores 
