...
---
= Substitua o controlador node1 AFF A700 ou FAS9000 e os módulos NVRAM
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Substitua o controlador node1 AFF A700 ou FAS9000 e os módulos NVRAM pelos módulos do controlador e NVRAM ASA A900, AFF A900 ou FAS9500.
...
Desconecte e remova o módulo controlador node1 AFF A700 ou FAS9000.
...
Desbloqueie e remova o módulo NVRAM do node1 AFF A700 ou FAS9000.
...
Instale, conecte os cabos e conecte o módulo ASA A900, AFF A900 ou FAS9500 NVRAM no node1.
...
== Etapa 4: Instale o módulo controlador ASA A900, AFF A900 ou FAS9500 no node1

Instale, conecte os cabos e conecte o módulo controlador ASA A900, AFF A900 ou FAS9500 em node1.
...
.O que se segue?
Após instalar os módulos do controlador ASA A900, AFF A900 ou FAS9500 e NVRAM, link:netboot-node1.html["netboot node1"].
