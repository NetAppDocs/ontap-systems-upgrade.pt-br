...
summary: Instale os módulos do sistema de substituição no nó2 durante um upgrade ARL dos modelos de controlador no mesmo chassi. 
---
= Instale o módulo controlador ASA A150, AFF A150 ou FAS2820 em node2
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Instale o módulo de controlador ASA A150, AFF A150 ou FAS2820 que você recebeu para o upgrade no nó2. O nó2 é o controlador B localizado no lado direito do chassi quando se olha para os controladores pela parte traseira do sistema.
