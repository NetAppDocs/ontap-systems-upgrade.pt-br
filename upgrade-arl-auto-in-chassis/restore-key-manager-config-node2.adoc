...
.O que se segue?
Após restaurar a configuração do gerenciador de chaves no nó 2, link:verify-rcf-configuration.html["verifique a configuração RCF nos switches do cluster"].
