...
Se você estiver atualizando para um cluster sem switch de dois nós, pode pular esta seção e ir para link:move-non-root-aggr-and-nas-data-lifs-back-to-node2.html["Migre agregados que não sejam raiz e LIFs de dados nas de volta para node2"].
...
| `Up` | Vá para link:move-non-root-aggr-and-nas-data-lifs-back-to-node2.html["Migre agregados que não sejam raiz e LIFs de dados nas de volta para node2"]. 
...
.O que se segue?
Após verificar a configuração do RCF link:move-non-root-aggr-and-nas-data-lifs-back-to-node2.html["Mova os agregados não raiz e os LIFs de dados NAS de volta para o node2"].
