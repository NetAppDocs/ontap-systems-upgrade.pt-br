...
.O que se segue?
Após gerenciar autenticação usando servidores KMIP, link:confirm-new-controllers-are-set-up-correctly.html["Confirme se os novos controladores estão configurados corretamente"].
