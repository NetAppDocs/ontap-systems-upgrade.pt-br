...
.O que se segue?
Após restaurar a configuração do gerenciador de chaves no nó1 atualizado, link:move-non-root-aggr-nas-lifs-node1-from-node2-to-upgraded-node1.html["Mova os agregados não raiz do node1 e os LIFs de dados NAS do node2 para o node1 atualizado"].
