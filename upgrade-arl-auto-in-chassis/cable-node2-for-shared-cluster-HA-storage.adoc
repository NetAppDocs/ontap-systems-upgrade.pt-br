...
summary: Conecte as conexões de cluster, HA, armazenamento e dados que estavam anteriormente conectadas ao AFF A800 node2 ao novo AFF A90 ou AFF A70 node2 recém-instalado. 
---
...
.O que se segue?
Após a instalação dos cabos no nó2 para cluster-HA compartilhado e armazenamento, link:boot-node2-with-a900-controller-and-nvs.html["Inicialize o node2 com os módulos de sistema de substituição"].
