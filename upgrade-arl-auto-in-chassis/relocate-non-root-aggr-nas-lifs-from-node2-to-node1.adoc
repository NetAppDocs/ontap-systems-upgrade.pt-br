...
.O que se segue?
Após realocar agregados não raiz e LIFs de dados NAS do nó 2 para o nó 1, link:relocate-failed-or-vetoed-aggr-node1.html["realocar agregados com falha ou vetados para o node1"].
