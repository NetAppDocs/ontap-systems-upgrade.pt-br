...
summary: Caso necessário, configure o novo módulo de controlador para NVE ou NAE ao usar o ARL para atualizar os modelos de controlador no mesmo chassi. 
---
...
.O que se segue?
Após configurar a criptografia de volume ou agregada NetApp no novo módulo controlador, link:decommission-old-system.html["desativar o sistema antigo"].
