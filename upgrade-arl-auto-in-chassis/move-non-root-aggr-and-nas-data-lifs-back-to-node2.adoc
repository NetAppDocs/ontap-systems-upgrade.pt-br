...
.O que se segue?
Após mover agregados não raiz e LIFs de dados NAS de volta para o nó2, link:manage-authentication-using-kmip-servers.html["Gerenciar autenticação usando servidores KMIP"].
