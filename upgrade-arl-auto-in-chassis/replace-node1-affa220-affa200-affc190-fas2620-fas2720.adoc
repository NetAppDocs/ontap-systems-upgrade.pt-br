...
---
= Substitua o módulo controlador node1 AFF A220, AFF A200, AFF C190, FAS2620 ou FAS2720
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Substitua o módulo controlador node1 AFF A220, AFF A200, AFF C190, FAS2620 ou FAS2720 por um módulo controlador ASA A150, AFF A150 ou FAS2820.
...
Para acessar os componentes dentro do controlador node1, remova o módulo do controlador do sistema e depois remova a tampa do módulo do controlador.
...
.O que se segue?
Após instalar o módulo controlador ASA A150, AFF A150 ou FAS2820, link:netboot-node1.html["netboot node1"].
