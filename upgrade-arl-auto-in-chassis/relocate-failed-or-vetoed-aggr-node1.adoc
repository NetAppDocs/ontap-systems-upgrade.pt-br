...
summary: Realocar manualmente os agregados com falha ou vetados para o node1 ao usar o ARL para atualizar modelos de controlador no mesmo chassi. 
---
...
.O que se segue?
Após realocar agregados com falha ou vetados para o nó 1, link:retire-node2.html["desativar node2"].
