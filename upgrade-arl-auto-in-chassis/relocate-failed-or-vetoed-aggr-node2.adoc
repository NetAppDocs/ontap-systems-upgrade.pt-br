...
summary: Realoque agregados com falha ou vetados para o node2 ao usar o ARL para atualizar modelos de controlador no mesmo chassi. 
---
...
.O que se segue?
Após realocar agregados com falha ou vetados para o nó 2, link:retire-node1.html["desativar node1"].
