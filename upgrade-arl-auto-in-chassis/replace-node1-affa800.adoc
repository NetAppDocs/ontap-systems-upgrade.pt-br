...
---
= Substitua o módulo controlador node1 AFF A800 ou AFF C800
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.O que se segue?
Após instalar o módulo controlador AFF A90, AFF A70 ou AFF C80, link:netboot-node1.html["netboot node1"].
