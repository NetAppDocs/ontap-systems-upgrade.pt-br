...
.O que se segue?
Após configurar a criptografia de armazenamento no novo módulo controlador, link:set-up-netapp-volum-encryption-new-module.html["Configurar a criptografia de Volume ou Aggregate da NetApp no novo módulo de controlador"].
