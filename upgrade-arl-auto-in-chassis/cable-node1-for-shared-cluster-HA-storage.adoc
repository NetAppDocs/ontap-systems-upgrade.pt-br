...
summary: Conecte as conexões do cluster, par de HA, storage e dados que estavam anteriormente conectadas ao AFF A800 node1 ao AFF A90 ou AFF A70 node1 recém-instalado. 
---
...
.O que se segue?
Após a instalação dos cabos no node1 para cluster-HA compartilhado e armazenamento, link:boot-node1-with-a900-controller-and-nvs.html["Inicialize o node1 com os módulos de sistema de substituição"].
