...
.O que se segue?
Após confirmar que os novos controladores estão configurados corretamente, link:set-up-storage-encryption-new-module.html["Configurar a criptografia de armazenamento no novo módulo controlador"].
