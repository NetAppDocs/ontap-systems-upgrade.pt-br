...
[role="lead"]
Instale o módulo de controlador AFF A90 ou AFF A70 que você recebeu para o upgrade no node2. O node2 é o controlador B localizado na baia inferior do chassi quando se olha para os controladores pela parte traseira do sistema.
