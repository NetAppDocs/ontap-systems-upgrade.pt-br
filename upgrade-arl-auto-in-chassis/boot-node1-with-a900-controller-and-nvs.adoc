...
[role="lead"]
O Node1 com os módulos de substituição já está pronto para inicializar.  Os módulos de substituição suportados estão listados emlink:decide_to_use_the_aggregate_relocation_guide.html#supported-systems-in-chassis["matriz de sistemas suportados"] .
