...
+
Insira a senha e as informações de backup que você anotou anteriormente no procedimento. Consulte link:manage-storage-encryption-using-okm.html["Gerencie a criptografia de armazenamento usando o Gerenciador de chaves integrado"].
