...
Consulte link:other-references.html["Referências"] para acessar a lista de documentos e sites de referência necessários para esta atualização.

.O que se segue?
Após analisar as ferramentas e a documentação necessárias, link:guidelines-for-upgrading-controllers-with-arl.html["Saiba mais sobre as diretrizes para atualização de controladores"].
