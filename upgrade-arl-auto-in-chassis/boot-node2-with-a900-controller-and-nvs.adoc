...
[role="lead"]
O Node2 com os módulos de substituição está agora pronto para inicializar. Os módulos de substituição suportados estão listados em link:decide-to-use-the-aggregate-relocation-guide.html#supported-systems-in-chassis["matriz de sistemas suportados"].
...
.O que se segue?
Após inicializar o nó2 com os módulos de sistema de substituição, link:verify-node2-installation.html["Verifique a instalação do nó2"].
