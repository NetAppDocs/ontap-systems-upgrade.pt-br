...
| link:verify-upgrade-hardware.html["Etapa 1: Prepare-se para a atualização"]  a| 
...
| link:relocate-non-root-aggr-and-nas-data-lifs-node1-node2.html["Etapa 2: Realocar recursos e aposentar-se node1"]  a| 
...
| link:relocate-non-root-aggr-nas-lifs-from-node2-to-node1.html["Etapa 4: Realocar recursos e aposentar-se node2"]  a| 
...
| link:install-aff-a30-a50-c30-c50-node2.html["Etapa 5: instalar os módulos de sistema de substituição do nó 2"]  a| 
...
| link:cable-node2-for-shared-cluster-HA-storage.html["Fase 6: Arranque node2 com os módulos do sistema de substituição"]  a| 
