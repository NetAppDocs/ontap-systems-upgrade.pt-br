...
summary: Caso necessário, restaure a configuração do gerenciador de chaves no node4 durante uma atualização manual do ARL em controladores que executam ONTAP 9.8 ou posterior. 
---
