...
+
Para obter informações detalhadas sobre o  `network interface revert` comando, consulte link:other_references.html["Referências"] para acessar a _ONTAP 9 Command reference_.
...
+
Você pode querer reutilizar os parâmetros de rede dos dispositivos de gerenciamento remoto, neste caso os SPs, do sistema original para os SPs nos novos nós. Para obter informações detalhadas sobre o SP, consulte link:other_references.html["Referências"] o _System Administration Reference_ e o _ONTAP 9 Command reference_.
...
+
Para obter informações detalhadas sobre AutoSupport, consulte link:other_references.html["Referências"] para acessar o _System Administration Reference_ e o _ONTAP 9 Command reference_.
