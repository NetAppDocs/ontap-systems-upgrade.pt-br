...
+
Acesse link:other_references.html["Referências"] para acessar o _System Administration Reference_ para obter informações sobre os SPs e o _ONTAP 9 Command reference_ para obter informações detalhadas sobre o  `system service- processor network modify` comando.
