...
[role="lead"]
Você deve garantir que as portas físicas no nó2 estejam mapeadas corretamente para as portas físicas no nó4. Isso permite que o nó4 se comunique com outros nós no cluster e com a rede após a atualização.
...
.O que se segue?
Após mapear as portas do nó 2 para o nó 4, link:move_nas_lifs_node2_from_node3_node4_verify_san_lifs_node4.html["Mova os LIFs de dados NAS pertencentes ao node2 do node3 para o node4 e verifique os LIFs SAN no node4"].
