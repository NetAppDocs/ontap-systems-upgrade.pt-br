...
.O que se segue?
Após gerenciar autenticação usando servidores KMIP, link:ensure_controllers_set_up_correctly.html["Confirme se os novos controladores estão configurados corretamente"].
