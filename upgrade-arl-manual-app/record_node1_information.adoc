...
+
Os domínios de broadcast precisam ser mapeados para as novas portas no novo controlador posteriormente no procedimento.
...
.O que se segue?
Após registrar as informações do node1, link:retire_node1.html["desativar node1"].
