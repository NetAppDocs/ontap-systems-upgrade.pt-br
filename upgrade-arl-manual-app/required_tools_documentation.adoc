...
.O que se segue?
Após analisar as ferramentas e a documentação necessárias, link:worksheet_information_before_during_upgrade.html["Registre as informações originais do nó para uso durante a atualização"].
