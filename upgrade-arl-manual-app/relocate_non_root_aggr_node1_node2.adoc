...
Consulte link:other-references.html["Referências"] para acessar o conteúdo _Gerenciamento de disco e agregados com a CLI_ e a _Referência de comandos do ONTAP 9_ para obter mais informações sobre os comandos de realocação de agregados de armazenamento.
