...
.O que se segue?
Após configurar a criptografia de armazenamento no novo módulo controlador, link:set_up_netapp_encryption_on_new_controller.html["Configurar a criptografia de Volume ou Aggregate da NetApp no novo módulo de controlador"].
