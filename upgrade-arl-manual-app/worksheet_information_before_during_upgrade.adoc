...
|===
.O que se segue?
Após registrar as informações originais do nó, link:determine_aggregates_on_internal_drives.html["determine se o controlador possui agregados em unidades de disco internas"].
