...
Todas as chaves de licença têm 28 caracteres alfabéticos maiúsculos. Consulte link:other-references.html["Referências"] para acessar o _NetApp Support Site_, onde você pode obter novas chaves de licença de 28 caracteres para ONTAP 9.8 ou posterior. As chaves estão disponíveis na seção _My Support_ em _Software licenses_. Se o site não tiver as chaves de licença que você precisa, entre em contato com seu representante de vendas NetApp.
...
.O que se segue?
Após revisar as diretrizes para atualização de controladores com ARL, link:required_tools_documentation.html["Analise as ferramentas e a documentação necessárias"].
