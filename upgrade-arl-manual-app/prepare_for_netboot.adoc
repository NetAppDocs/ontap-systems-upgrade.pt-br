...
* Consulte link:other-references.html["Referências"] para acessar o site de suporte da NetApp e baixar os arquivos de sistema necessários para sua plataforma e a versão correta do ONTAP.
...
.O que se segue?
Após preparar para inicialização pela rede, link:relocate_non_root_aggr_node1_node2.html["realocar agregados não raiz do node1 para o node2"].
