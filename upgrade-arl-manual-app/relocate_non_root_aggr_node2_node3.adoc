...
Para obter mais informações sobre os comandos de realocação de agregados de armazenamento, acesse link:other-references.html["Referências"] para acessar _Gerenciamento de disco e agregado com a CLI_ e a _Referência de comandos do ONTAP 9_.
