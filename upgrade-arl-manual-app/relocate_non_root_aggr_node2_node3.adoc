...
Para obter mais informações sobre os comandos de realocação de agregados de armazenamento, acesse link:other_references.html["Referências"] para acessar _Gerenciamento de disco e agregado com a CLI_ e a _Referência de comandos do ONTAP 9_.
...
.O que se segue?
Após realocar agregados não raiz do nó 2 para o nó 3, link:move_nas_lifs_node2_node3.html["mover LIFs de dados NAS pertencentes ao node2 para o node3"].
