...
summary: Configurar as portas FC integradas do node4, as portas UTA e UTA2 ou a placa UTA e UTA2 durante uma atualização manual do ARL em controladoras que executam o ONTAP 9.8 ou posterior. 
---
...
.O que se segue?
Após configurar o FC ou UTA/UTA2 no nó 4, link:map_ports_node2_node4.html["mapear portas do nó 2 para o nó 4"].
