...
Para obter mais informações sobre os comandos de realocação de agregados de armazenamento, consulte link:other-references.html["Referências"] para link para _Gerenciamento de disco e agregado com a CLI_ e a _ONTAP 9 Command reference_.
