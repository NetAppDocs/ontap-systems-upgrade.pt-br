...
Para obter mais informações sobre os comandos de realocação de agregados de armazenamento, consulte link:other_references.html["Referências"] para link para _Gerenciamento de disco e agregado com a CLI_ e a _ONTAP 9 Command reference_.
...
.O que se segue?
Após realocar os agregados não raiz do nó 2 do nó 3 para o nó 4, link:manage_authentication_kmip.html["Gerenciar autenticação usando servidores KMIP"].
