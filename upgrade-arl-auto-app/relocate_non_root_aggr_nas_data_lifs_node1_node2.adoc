...
.O que se segue?
Após realocar agregados não raiz e LIFs de dados NAS pertencentes ao node1 para o node2, link:relocate-failed-or-vetoed-aggr-node2.html["realocar agregados com falha ou vetados"].
