...
+
Para atualizar as configurações de IP do MetroCluster, consulte link:other-references.html["Referências"] para acessar _MetroCluster Upgrade and Expansion_.
...
^4^A tabela a seguir mostra as versões do ONTAP compatíveis com as combinações de atualização do controlador.
...
| FAS2720 | 9.13.1 ou posterior | FAS2820 | 9.13.1 ou posterior 


| FAS2760 | 9.11.1P7 ou anterior | FAS2820 | 9.13.1 ou posterior 
...
.O que se segue?
Após decidir se deve usar este procedimento ARL, aprenda sobre o link:required_tools_and_documentation.html["Ferramentas e documentação necessárias"].
