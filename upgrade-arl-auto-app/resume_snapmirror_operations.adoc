...
summary: 'Retome as transferências e relacionamentos do SnapMirror ao atualizar controladores executando o ONTAP 9.8 ou posterior usando `system controller replace` comandos.' 
---
