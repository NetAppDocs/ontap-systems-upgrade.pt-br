...
summary: Configure as portas FC integradas do nó 4, as portas UTA e UTA2, ou a placa UTA e UTA2 ao atualizar controladores que executam o ONTAP 9.8 ou posterior usando comandos system controller replace. 
---
...
.Sobre esta tarefa
Você poderá precisar preencher <<configure-fc-ports-on-node4,Configurar portas FC no node4>>, ou <<check-config-uta-uta2-node4,Verifique e configure as portas UTA/UTA2 no node4>>, ou ambas as seções.

[NOTE]
====
Se o nó 4 não tiver portas FC integradas, portas UTA/UTA2 integradas ou uma placa UTA/UTA2 (por exemplo, sistemas AFF e FAS introduzidos no ONTAP 9.15.1 ou posterior) e você estiver atualizando um sistema com discos de armazenamento, você pode pular para link:reassign-node2-disks-to-node4.html["Reatribuir discos node2 a node4"].
...
== Etapa 1: configurar as portas FC no nó4
...
.Sobre esta tarefa
Você pode pular esta seção se o seu sistema não tiver configurações FC. Se o seu sistema tiver portas UTA/UTA2 integradas ou um adaptador UTA/UTA2, você as configura em <<check-config-uta-uta2-node4,Verifique e configure as portas UTA/UTA2 no node4>>.
...
+
** Vá para <<check-config-uta-uta2-node4,Verifique e configure as portas UTA/UTA2 no node4>> se o nó 4 possui uma placa UTA/UTA2 ou portas UTA/UTA2 integradas.
...
== Etapa 2: verifique e configure as portas UTA/UTA2 no nó 4
