...
+
Se você estiver atualizando para um A800, vá para link:reassign-node2-disks-to-node4.html#reassign-node2-node4-app-step9["Reatribuir discos do nó 2 ao nó 4, etapa 9"].
