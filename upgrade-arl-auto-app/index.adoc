...
* Se você estiver atualizando de um sistema AFF A320, poderá usar a movimentação de volumes para atualizar o hardware do controlador ou entrar em contato com o suporte técnico. Consulte link:other-references.html["Referências"] para acessar _Upgrade movendo volumes ou armazenamento_.
...
.O que se segue?
Após tomar conhecimento deste procedimento ARL, link:decide_to_use_the_aggregate_relocation_guide.html["decida se deve usar este procedimento ARL"].
