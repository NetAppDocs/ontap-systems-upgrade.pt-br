...
summary: 'Realoque manualmente agregados com falha ou vetados para o node3 ao atualizar controladores executando ONTAP 9.8 ou posterior usando `system controller replace` comandos.' 
---
...
.O que se segue?
Após a realocação de agregados reprovados ou vetados, link:retire_node2.html["desativar node2"].
