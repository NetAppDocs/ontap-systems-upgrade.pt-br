...
summary: 'Deixe o NetApp saber que o sistema antigo não está mais em operação depois de atualizar controladores executando o ONTAP 9.8 ou posterior usando `system controller replace` comandos.' 
---
