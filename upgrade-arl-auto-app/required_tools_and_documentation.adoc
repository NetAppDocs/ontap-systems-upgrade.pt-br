...
.O que se segue?
Após analisar as ferramentas e a documentação necessárias, aprenda sobre o link:guidelines_for_upgrading_controllers_with_arl.html["diretrizes para atualização de controladores com ARL"].
