...
Se as portas físicas no nó 2 não corresponderem diretamente às portas físicas no nó 4, a seção seguinte <<restore_network_configuration_on_node4,Restaure a configuração de rede no node4>> deve ser utilizada para reparar a conectividade de rede.
