...
Inicie o processo de substituição do controlador e execute as verificações prévias. Se necessário, determine o tipo de unidades de criptografia automática em uso.
