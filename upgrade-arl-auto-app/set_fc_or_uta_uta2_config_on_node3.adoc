...
.Sobre esta tarefa
Você pode pular esta seção se o seu sistema não tiver configurações FC. Se o seu sistema tiver portas UTA/UTA2 integradas ou uma placa UTA/UTA2, você as configura em <<check-config-uta-uta2-node3,Verifique e configure as portas UTA/UTA2 no node3>>.
...
| Possui uma placa UTA/UTA2 ou portas UTA/UTA2 integradas | Vá para <<check-config-uta-uta2-node3,Verifique e configure as portas UTA/UTA2 no node3>> 
...
== Etapa 2: Verifique e configure as portas UTA/UTA2 no nó 3
