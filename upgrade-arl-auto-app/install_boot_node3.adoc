...
+
Insira a senha e as informações de backup que você anotou anteriormente no procedimento. Consulte link:manage_storage_encryption_using_okm.html["Gerencie a criptografia de armazenamento usando o Gerenciador de chaves integrado"].
