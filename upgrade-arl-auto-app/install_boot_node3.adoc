...
+
Se você não tiver uma configuração FC ou UTA/UTA2, execute link:reassign-node2-disks-to-node4.html#reassign-node1-node3-app-step1["Reatribuir discos node1 a node3, passo 1"] para que o node3 possa reconhecer os discos do node1.
