...
* link:upgrade/upgrade-decide-to-use-this-guide.html["Mover armazenamento"]
+
Você pode atualizar sem interrupções de um AFF A250 para um AFF A400 ou de um FAS2820 para um sistema de substituição convertendo os nós originais em gavetas de unidades e, em seguida, conectando as gavetas de unidades aos nós de substituição para mover o armazenamento integrado.
