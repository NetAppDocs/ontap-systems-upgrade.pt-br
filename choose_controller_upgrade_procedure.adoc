...
| Tenho um sistema integrado e quero atualizá-lo trocando apenas o módulo controlador, mantendo o chassi e os discos existentes? | link:upgrade-arl-auto-in-chassis/index.html["Atualize usando o ARL, mantendo o mesmo chassi e discos."]. 
