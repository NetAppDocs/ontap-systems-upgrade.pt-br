...
* Se você estiver atualizando de um sistema AFF A320, poderá usar a movimentação de volumes para atualizar o hardware do controlador ou entrar em contato com o suporte técnico. Se você estiver disposto a fazer a movimentação de volumes, consulte link:other-references.html["Referências"] para acessar _Atualizar movendo volumes ou armazenamento_.
