...
| Tem discos de armazenamento  a| 
** Ignore esta seção e vá para link:reassign-node2-disks-to-node4.html["Reatribuir discos node2 a node4"] se node4 não tiver uma placa UTA/UTA2 ou portas integradas UTA/UTA2.
...
** Ignorar _verificar e configurar portas UTA/UTA2 no node4_ se o node4 não tiver uma placa UTA/UTA2 ou portas integradas UTA/UTA2, retorne a _Instalar e inicializar node4_ e continue em link:install_boot_node4.html#auto_install4_step23["Passo 23"].
...
+
Se você estiver atualizando para um A800, vá para link:reassign-node2-disks-to-node4.html#auto_check_4_step9["Reatribuir discos node2 a node4, passo 9"].
