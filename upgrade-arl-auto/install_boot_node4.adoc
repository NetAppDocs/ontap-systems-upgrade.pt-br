...
* Se você tiver uma configuração MetroCluster ,link:set_fc_or_uta_uta2_config_node4.html["defina a configuração FC ou UTA/UTA2 no node4"] para detectar os discos anexados ao nó.
