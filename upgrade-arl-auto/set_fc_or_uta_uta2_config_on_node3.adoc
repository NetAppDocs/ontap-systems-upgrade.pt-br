...
+
** Se o nó 3 tiver uma placa UTA/UTA2 ou portas UTA/UTA2 integradas, acesse <<check-config-uta-uta2-node3,Verifique e configure as portas UTA/UTA2 no node3>>.
** Se o node3 não tiver uma placa UTA/UTA2 ou portas UTA/UTA2 integradas, ignore <<check-config-uta-uta2-node3,Verifique e configure as portas UTA/UTA2 no node3>> e vá para link:reassign-node1-disks-to-node3.html["Reatribuir discos node1 a node3"].
