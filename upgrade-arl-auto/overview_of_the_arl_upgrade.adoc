...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-2.png["Dois"]link:relocate_non_root_aggr_and_nas_data_lifs_node1_node2.html["Fase 2. Transferir e retirar node1"]
[role="quick-margin-para"]
