...
summary: Configure as portas FC integradas do node4, as portas UTA e UTA2, ou a placa UTA e UTA2 ao atualizar controladores executando o ONTAP 9.5 para 9.7 usando comandos system controller replace. 
---
...
NOTE: Você poderá encontrar um erro nesta etapa.  Se ocorrer um erro, repita as subetapas em<<auto_check_4_step8,Passo 8>> até que o sistema inicialize normalmente.
