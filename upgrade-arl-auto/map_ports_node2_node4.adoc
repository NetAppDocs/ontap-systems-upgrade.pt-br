...
+
Consulte link:other_references.html["Referências"] para acessar _Network Management_ ou o _ONTAP 9 Command reference_ e veja _Configuring failover settings on a LIF_ para mais informações.
