...
.O que se segue?
* Se você tiver um sistema com uma configuração FC ou UTA/UTA2,link:set_fc_or_uta_uta2_config_on_node3.html["defina a configuração FC ou UTA/UTA2 no node3"] .
* Se você não tiver uma configuração FC ou UTA/UTA2,link:reassign-node1-disks-to-node3.html#reassign-node1-node3-step1["reatribuir discos node1 para node3"] para que o nó3 possa reconhecer os discos do nó1.
