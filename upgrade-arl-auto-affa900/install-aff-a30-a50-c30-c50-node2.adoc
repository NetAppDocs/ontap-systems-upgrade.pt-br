...
[role="lead"]
Instale o módulo do controlador de substituição que recebeu para a atualização em node2. O Node2 é o controlador B localizado no lado direito do chassi quando se olha para os controladores da parte traseira do sistema.
