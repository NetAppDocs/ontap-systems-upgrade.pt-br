...
+
Para obter informações detalhadas sobre as  `storage aggregate relocation start`, `override-vetoes`, e  `override-destination-checks` opções, consulte link:other-references.html["Referências"] para o link para a _ONTAP 9 Command reference_.
