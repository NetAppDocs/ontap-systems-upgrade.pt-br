...
.Antes de começar
Você já deve ter informações sobre as portas nos novos nós do _Hardware Universe_. (Acesse link:other-references.html["Referências"] para acessar o _Hardware Universe_). Você usará essas informações mais adiante nesta seção e em link:map_ports_node2_node4.html["Portas de mapa de node2 a node4"].
...
----
+
Vá para link:other-references.html["Referências"] para acessar o link para _Gerenciamento de Rede_ ou o _ONTAP 9 Command reference_ para mais informações.
