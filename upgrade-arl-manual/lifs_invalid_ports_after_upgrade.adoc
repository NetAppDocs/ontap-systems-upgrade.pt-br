...
summary: Ressincronizar LIFs que estão em portas inválidas em uma configuração do MetroCluster após uma atualização manual do ARL em controladores executando o ONTAP 9.7 ou anterior. 
---
