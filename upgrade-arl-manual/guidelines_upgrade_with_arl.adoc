...
+
Para obter informações sobre atualizações de controladores para sistemas que executam Data ONTAP operando em 7-Mode, consulte link:other-references.html["Referências"] para acessar o _NetApp Support Site_.

* Para substituir as controladoras que não são compatíveis com as gavetas de disco conectadas às controladoras originais.
+
Para informações sobre suporte a discos, consulte link:other-references.html["Referências"] para acessar o _Hardware Universe_.

* Desde controladoras com agregados de raiz ou agregados de dados em unidades internas.
+
Se você deseja atualizar controladores com agregados raiz ou agregados de dados em unidades de disco internas, consulte link:other-references.html["Referências"] para acessar _Atualizar movendo volumes ou armazenamento_ e vá para o procedimento _Atualizando um par de nós executando Clustered Data ONTAP movendo volumes_.

+

NOTE: Se você deseja atualizar ONTAP em nós de um cluster, consulte link:other-references.html["Referências"] para acessar _Upgrade ONTAP_.
...
Todas as chaves de licença têm 28 caracteres alfabéticos maiúsculos. Consulte link:other-references.html["Referências"] para acessar o _NetApp Support Site_, onde você pode obter novas chaves de licença de 28 caracteres para ONTAP 9.7 ou versões anteriores. As chaves estão disponíveis na seção _My Support_ em _Software licenses_. Se o site não tiver as chaves de licença que você precisa, entre em contato com seu representante de vendas da NetApp.

Para obter informações detalhadas sobre licenciamento, acesse link:other-references.html["Referências"] para acessar a _Referência de Administração do Sistema_.
