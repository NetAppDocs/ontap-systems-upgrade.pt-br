...
.Antes de começar
O uso da porta do switch FC deve corresponder ao uso descrito no conteúdo _Fabric-attached MetroCluster Installation and Configuration_ para que os RCFs possam ser utilizados. Vá para link:other-references.html["Referências"] para acessar o conteúdo _Fabric-attached MetroCluster Installation and Configuration_.
